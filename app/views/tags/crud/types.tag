%{
    models = [];
    for(controllerClass in play.Play.classloader.getAssignableClasses(_('controllers.CRUD_2'))) {
        resourceModel = _('controllers.CRUD_2$ObjectType').get(controllerClass)
