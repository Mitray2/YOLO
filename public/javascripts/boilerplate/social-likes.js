...
var services = {
	facebook: {
		...
		popupUrl: 'https://www.facebook.com/sharer/sharer.php?s=100&p%5Burl%5D={url}&p%5Bsummary%5D={description}&p%5Bimages%5D%5B0%5D={image}&p%5Btitle%5D={title}',
		pupupWidth: 600,
		popupHeight: 500
	},
	twitter: {
		...
		popupUrl: 'http://twitter.com/intent/tweet?url={url}&text={twit}',
		pupupWidth: 600,
		popupHeight: 450,
	...
	vkontakte: {
		...
		popupUrl: 'http://vk.com/share.php?url={url}&title={title}&description={description}&image={image}',
		pupupWidth: 550,
		popupHeight: 330
	},
	odnoklassniki: {
