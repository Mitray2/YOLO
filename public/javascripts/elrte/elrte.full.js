...
elRTE.prototype.save = function() {
	saveToTextArea($.trim(this.val())||'', this.textarea);
...
elRTE.prototype.selection = function(rte) {
	...
	this.insertNode = function(n, collapse) {
		...
		if (this.rte.browser.msie) {
			...
			var r = this.getRangeAt();
			var nTitle = n.title + '';
	 		var nTitleLength = nTitle.length;
	 		var nodeToInsert
	 		var suffix = nTitle.substring(nTitleLength - 4,nTitleLength);
	 		if('.mp3' === suffix){
	 			var obj = document.createElement('object');
	 			obj.setAttribute('type', 'application/x-shockwave-flash');
	 			obj.setAttribute('data', 'http://flv-mp3.com/i/pic/ump3player_500x70.swf');
	 			obj.setAttribute('height', '70');
	 			obj.setAttribute('width', '470');
	 			...
	 			param4.setAttribute('name', 'movie');
	 			param4.setAttribute('value', 'http://flv-mp3.com/i/pic/ump3player_500x70.swf');
	 			
	 			var param5 = document.createElement('param');
	 			param5.setAttribute('name', 'FlashVars');
	 			param5.setAttribute('value', 'way=' + nTitle + '&amp;swf=http://flv-mp3.com/i/pic/ump3player_500x70.swf&amp;w=470&amp;h=70&amp;time_seconds=0&amp;autoplay=0&amp;q=&amp;skin=red&amp;volume=70&amp;comment=asdasd');
	 			...
	 			var obj = document.createElement('object');
	 			obj.setAttribute('type', 'application/x-shockwave-flash');
	 			obj.setAttribute('data', 'http://flv-mp3.com/i/pic/uflvplayer_500x375.swf');
	 			...
	 			var param4 = document.createElement('param');
	 			param4.setAttribute('name', 'movie');
	 			param4.setAttribute('value', 'http://flv-mp3.com/i/pic/uflvplayer_500x375.swf');
	 			
	 			var param5 = document.createElement('param');
	 			param5.setAttribute('name', 'FlashVars');
	 			param5.setAttribute('value', 'way=' + nTitle + '&amp;swf=http://flv-mp3.com/i/pic/uflvplayer_500x375.swf&amp;w=400&amp;h=300&amp;pic=http://&amp;autoplay=0&amp;tools=1&amp;skin=white&amp;volume=70&amp;q=&amp;comment=');
	...
	elRTE.prototype.ui.prototype.buttons.flash = function(rte, name) {
		...
		this.src = {
			...
			type   : $('<select name="type"/>')
						.append('<option value="application/x-shockwave-flash">Multimedia</option>'),
		...
		this.command = function() {
			...
			this.src.url.change(function() {
				...
				if (url) {
					...
					var suffix = url.substring(urlLength - 4,urlLength);
					if('.mp3' === suffix){
						swf = '<object type="application/x-shockwave-flash" data="http://flv-mp3.com/i/pic/ump3player_500x70.swf" ' + 
							'height="70" width="470"><param name="wmode" value="transparent" /><param name="allowFullScreen" value="true" />' +
							'<param name="allowScriptAccess" value="always" /><param name="movie" value="http://flv-mp3.com/i/pic/ump3player_500x70.swf" />' + 
							'<param name="FlashVars" value="way=' + url + '&amp;swf=http://flv-mp3.com/i/pic/ump3player_500x70.swf&amp;w=470&amp;h=70&amp;' + 
							'time_seconds=0&amp;autoplay=0&amp;q=&amp;skin=red&amp;volume=70&amp;comment=asdasd" /></object>';
					} else if('.flv' == suffix){
						swf = '<object type="application/x-shockwave-flash" data="http://flv-mp3.com/i/pic/uflvplayer_500x375.swf" ' + 
						'height="300" width="400"><param name="bgcolor" value="#FFFFFF" /><param name="allowFullScreen" value="true" />' + 
						'<param name="allowScriptAccess" value="always" /><param name="movie" value="http://flv-mp3.com/i/pic/uflvplayer_500x375.swf" />' + 
						'<param name="FlashVars" value="way=' + url + '&amp;swf=http://flv-mp3.com/i/pic/uflvplayer_500x375.swf&amp;' + 
						'w=400&amp;h=300&amp;pic=http://&amp;autoplay=0&amp;tools=1&amp;skin=white&amp;volume=70&amp;q=&amp;comment=" /></object>';
					} else {
